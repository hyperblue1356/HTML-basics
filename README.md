...
<!--Meta tags used by search engines to find and identfy sites. Meta tag 'viewport' important for display on mobile devices-->
...
<!--How to insert tables. th= tables header,
td= table description, colspan= column span,
